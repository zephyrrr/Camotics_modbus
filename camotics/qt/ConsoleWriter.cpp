...
ConsoleWriter::ConsoleWriter(QWidget *parent) : QTextEdit(parent), m_autoMoveToEnd(true) {
  ...
  menu.addAction("Toggle Auto Scroll", this, SLOT(on_autoMoveToEnd()));
  menu.addAction("Clear All", this, SLOT(clear()));

  //actionToggleAutoScroll->setStyleSheet(
  //    "QAction::checked {border-left: 5px solid red; padding-left: 5px;}"
  //);
  ...
  //QAction* mainAction = new QAction("Log", this);
  //QMenu* subMenu1 = new QMenu("Log");
  //subMenu1->addAction("Debug", this, SLOT(on_autoMoveToEnd()));
  //subMenu1->addAction("setVerbosity 0");
  //mainAction->setMenu(subMenu1);
  //menu.addAction(mainAction);
}

void ConsoleWriter::on_autoMoveToEnd()
{
    m_autoMoveToEnd = !m_autoMoveToEnd;
    QAction* senderAction = qobject_cast<QAction*>(sender());
    senderAction->setChecked(m_autoMoveToEnd);
}
